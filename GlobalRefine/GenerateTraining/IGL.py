...
class IGL:
    ...
    #def __init__(self,workPath,scriptPath,info):
        ...
        self.displ_temp = info['LocalAppliedDispl']
    ...
    def fixed_point_aitken(self):
        ...
        while self.iteration == 0:
            ...
            # else: 
            #     self.GlobalRF[self.iteration] = self.Glob.get_react_force_react_moment('False',self.iteration)[self.mapGlob2Glob]
            self.LocalAppliedDispl[self.iteration] = self.displ_temp
            ...
            df_p.to_csv(self.scriptPath + '\\Files\OutputData\S{}_Reaction.csv'.format(self.index))
