...
# index = 0
# workPath = 'C:\ZIHAN\GreenupCrackEstimation\SequentialSampling\Files\\'
# workPath = workPath + "\\S" +str(index) + "\\"
# scriptPath = 'C:\ZIHAN\GreenupCrackEstimation\SequentialSampling\\'
# sys.path.append(scriptPath) 
# cpuCount = 4
...
InputReconstruct = InputSpace[:,0:4] @ InputDecoder
...
Job['LocalAppliedDispl'] = np.array(np.reshape(InputReconstruct[index,:],(120,6)))
