...
#%% Save the training Space
filename = 'TrainingSpace.sav'
...
gp_GPML1 = GaussianProcessRegressor(kernel=kernel_prod, alpha=1e-7,n_restarts_optimizer=0,normalize_y=False,random_state=612)
...
gp_GPML2 = GaussianProcessRegressor(kernel=kernel_prod, alpha=1e-8,n_restarts_optimizer=0,normalize_y=False,random_state=612)
...
gp_GPML3 = GaussianProcessRegressor(kernel=kernel_prod, alpha=1e-7,n_restarts_optimizer=0,normalize_y=False,random_state=612)
...
gp_GPML5 = GaussianProcessRegressor(kernel=kernel_prod, alpha=2e-5,n_restarts_optimizer=0,normalize_y=False,random_state=612)
...
GP_Model = pickle.load(open("GP_Model0.pkl", "rb"))
encoder1 = GP_Model[0]
decoder1 = GP_Model[1]
encoder2 = GP_Model[2]
decoder2 = GP_Model[3]
